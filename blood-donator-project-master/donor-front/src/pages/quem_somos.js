    ...
    render() {
        return (
            ...
            <div className="fundo">
                ...
                <div className="cincoAmigos">
                    <h1>Quem são os 5 amigos ?</h1>
                    <p className="texto5Amigo">Os cincos amigos são estudante Universitário da faculdade Unimetrocamp, 
                    a amizade entre eles surgiram através de trabalhos em grupo da faculdade. Agora falaremos um 
                    pouquinho de cada um deles:</p>
                    <ul>
                        <li className="amigo1"><img src={beletatti} alt="Richard Beletatti"/>
