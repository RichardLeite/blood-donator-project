...
import risco from"../components/img/risco.png";

export class orientacoes extends Component {
    render() {
        return (
            <center>
         <div className="fundoOrientacoes">
             <div className="orientacoes">
                ...
                <ul className="orientacoes">
                    <li className="orientacoesRequisitos">
                        ...
                        <li className="orientacaoImpedimento">
                            <h5>IMPEDIMENTOS PARA A DOAÇÃO</h5>
                        </li>
                        ...
                        <li className="risco"><img src={risco} alt="risco"/></li>
                </ul>
                </div>
            </div>
            </center>
